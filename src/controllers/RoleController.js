...
exports.getRoles = async (req, res, next) => {
  try {
    ...
    logger.error(`Error with getting roles: ${err.message}`);
    next(err);
  }
};
...
exports.getRole = async (req, res, next) => {
  ...
  try {
    ...
    logger.error(
      `Error with getting role metadata by id: ${roleId}: ${err.message}`
    );
    next(err);
  }
};
...
exports.createRole = async (req, res, next) => {
  try {
    ...
    logger.error(`Error with creating new role: ${err.message}`);
    next(err);
  }
};
...
exports.deleteRole = async (req, res, next) => {
  ...
  try {
    ...
    logger.error(`Error with deleting role by id: ${roleId}: ${err.message}`);
    next(err);
  }
};
